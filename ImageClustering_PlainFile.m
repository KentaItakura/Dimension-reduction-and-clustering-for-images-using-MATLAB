...
% *[English]*
% 
% This demo shows how to perform image clustering and dimension reduction using 
% a pre-trained network. The network has learned rich feature representations 
% for a wide range of images. The feature extraction with the pre-trained network 
% can be utilized for image clustering. 
% 
% This demo did
% 
